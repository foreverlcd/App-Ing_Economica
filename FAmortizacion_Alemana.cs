...
{
    public partial class FAmortizacion_Alemana : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Capital = CalcularCapital(CapPrestado, Periodo);

                txbCuota.Text = Capital.ToString();
        ...
        public double CalcularCapital(double CapPrestado, int Periodo)
        {
            return CapPrestado / Periodo;
        }
        ...
        {
            txbPrestamo.Text = string.Empty;
            txbCuota.Text = string.Empty;
            txbFrecuencia.Text = string.Empty;
            txbTiempo.Text = string.Empty;
            txbTI.Text = string.Empty;
