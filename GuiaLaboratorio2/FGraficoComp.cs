...
{
    public partial class FGraficoComp : Form
    {
        private List<double> Datos;
        private string Categoria = "";
        public FGraficoComp(List<double> datosPrincipal, string Categoria)
        {
            InitializeComponent();
        ...
        private void FGraficoComp_Load(object sender, EventArgs e)
        {
        ...
        private void bucle(double Capital, double TI, int Tiempo)
        {
            ...
            {
                Interes = Capital * ((Math.Pow((1 + TI / 100), i) - 1));
